...
- * Настроена сборка и автоматическая публикация докер-образа на [https://hub.docker.com/](https://hub.docker.com/repositories/gingerfoxie/todo-list-golang)
...
# Сборка и настройка приложения. Запуск тестов
